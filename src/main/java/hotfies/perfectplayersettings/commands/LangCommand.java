...
public class LangCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!plugin.getConfig().getBoolean("commands.pflang", true)) {
            return true;
        }
        ...
        if (!langFile.exists()) {
            player.sendMessage(messageManager.getFormattedMessage(player, "LangNotAvailable", "%pf_prefix%", messageManager.getMessage(player, "Prefix")));
            return true;
        }
        ...
        Bukkit.getScheduler().runTaskAsynchronously(plugin, () -> {
            try (Connection connection = databaseManager.getConnection();
                ...
                Bukkit.getScheduler().runTask(plugin, () -> {
                    ...
                    player.sendMessage(messageManager.getFormattedMessage(player, "ChangeLangSucc", "%pf_prefix%", messageManager.getMessage(player, "Prefix"), "%pf_lang%", selectedLang));
                });
